...
import '../../../../logic/data/highlight_data.dart';
...
class _ArtifactScreenState extends State<ArtifactCarouselScreen> {
  ...
  void _handleArtifactTap(int index) {
    ...
    if (delta == 0) {
      ...
      context.push(ScreenPaths.project(data.artifactId));
    } else {
        ...
        Padding(
            ...
            child: Stack(
              children: [
                ...
                /// Header
                AppHeader(
                  title: $strings.projectsTitleProjects,
                  showBackBtn: false,
                  isTransparent: true,
                  trailing: (context) => CircleBtn(
                    semanticLabel: $strings.projectsButtonBrowse,
