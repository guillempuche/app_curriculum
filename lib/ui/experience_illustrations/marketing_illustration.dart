...
class ColosseumIllustration extends StatelessWidget {
  ...
  final String assetPath = ExperienceType.marketing.assetPath;
  final bgColor = ExperienceType.marketing.bgColor;
  ...
  Widget build(BuildContext context) {
    return ExperienceIllustrationBuilder(
      ...
      mgBuilder: _buildMg,
      fgBuilder: _buildFg,
      experienceType: ExperienceType.marketing,
    );
  }
  ...
  List<Widget> _buildFg(BuildContext context, Animation<double> anim) {
    return [
      const IllustrationPiece(
        fileName: 'quirky-rocket-start-up-1.png',
      ...
      IllustrationPiece(
        fileName: 'quirky-clip-board-with-analytics-1.png',
        alignment: Alignment.bottomCenter,
